  ...
  <jsp:include page="/WEB-INF/views/include/bs4.jsp" />
	<script>
		...
		function fileBoxAppend() {
			...
			fileBox += "<input type='button' value='삭제' onclick='deleteBox("+cnt+")' class='btn btn-danger form-control mb-3 ml-2' style='width:10%' />";
			fileBox += "</div>";
...
<jsp:include page="/WEB-INF/views/include/slide2.jsp" />
	...
	<div class="container">
		<form name="myform" method="post" enctype="multipart/form-data" >
			...
			<br />
			<div>
				<!-- <input type="button" value="파일박스추가" onclick="fileBoxAppend()" class="btn btn-info btn-sm mb-3" /> -->
				<input type="file" name="file" id="fName1" multiple class="form-control-file border mb-3" />
			</div>
			...
			<div class="mb-3">
				내용 : <textarea rows="4" name="content" id="content" placeholder="자료의 상제 내열을 입력하세요." class="form-control" ></textarea>
			</div>
			<div class="mb-3">
				분류 : 
				<select name="part" id="part" class="fomr-control">
